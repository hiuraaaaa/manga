...
export default function Admin(){
  ...
  return (
    <main className="container-page space-y-3">
      ...
      <p className="muted">Editor sederhana untuk katalog. Edit JSON, lalu Export.</p>
      ...
      <p className="muted">Catatan: ini client-side. Untuk upload gambar & multi-user, butuh backend/storage.</p>
    </main>
  )
}
